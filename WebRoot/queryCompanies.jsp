...
<html>
  <head>
    ...
    <body>
		...
		<%List<Company> list=(List<Company>)session.getAttribute("queryCompanies");
		int pages = 1;
  	    ...
  	    if(list.size() % pageNum != 0){
  	        pageCount = pageCount + 1;}%>  				
                        ...
                        <tr>
                            ...
                            <td><%=c.getZone()%></td>
                            <td>
									<a href="updateCompanyRedirectAction?cid=<%=c.getCid()%>" class="layui-btn layui-btn-mini   layui-btn-mini">编辑</a>
