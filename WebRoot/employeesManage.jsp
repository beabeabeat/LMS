...
<html>
  ...
  <body>
		...
		<div class="layui-inline">			
						...
						<input type="text" name="eid" id="eid" placeholder="请输入员工ID"  class="layui-input" />
		...
		<div class="layui-inline">			
						...
						<input type="text" name="department" placeholder="请输入员工部门"  class="layui-input" />
        ...
        <div class="layui-inline">			
						...
						<input type="text" name="company" placeholder="请输入员工公司"  class="layui-input" />
