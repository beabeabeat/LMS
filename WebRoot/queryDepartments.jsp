...
<html>
  <head>
    ...
    <body>
		...
		<%List<Department> list=(List<Department>)session.getAttribute("queryDepartments");
		int pages = 1;
  	    ...
  	    if(list.size() % pageNum != 0){
  	        pageCount = pageCount + 1;}%>  				
                        ...
                        <tr>
                            ...
                            <td><%=d.getDname() %></td>
                            <td>
									<a href="updateDepartmentRedirectAction.do?did=<%=d.getDid() %>" class="layui-btn layui-btn-mini   layui-btn-mini">编辑</a>
